                    ...
                    <div class="card-body">
                        <form method="post" action="{{route('product.store')}}" enctype="multipart/form-data">
                            ...
                            <div class="position-relative row form-group">
                                ...
                                <div class="col-md-9 col-xl-8">
                                    <input name="price" id="price"
                                        placeholder="Giá" type="text" class="form-control" value="{{old('price')}}">
                                    @error('price')
                                        <p class="text-danger mb-0">{{ $message }}</p>
                                    @enderror
                                </div>
                            ...
                            <div class="position-relative row form-group">
                                ...
                                <div class="col-md-9 col-xl-8">
                                    <input name="color" id="color"
                                        placeholder="Màu sắc" type="text" class="form-control" value="{{old('color')}}">
                                    @error('color')
                                        <p class="text-danger mb-0">{{ $message }}</p>
                                    @enderror
                                </div>
                            ...
                            <div class="position-relative row form-group">
                                ...
                                <div class="col-md-9 col-xl-8">
                                    <input name="product_code" id="product_code"
                                        placeholder="Mã sản phẩm" type="text" class="form-control" value="{{old('product_code')}}">
                                    @error('product_code')
                                        <p class="text-danger mb-0">{{ $message }}</p>
                                    @enderror
                                </div>
                            ...
                            <div id="input-container">
                                <div class="position-relative row form-group">
                                    <label for="size"
                                        class="col-md-3 text-md-right col-form-label">Kích cỡ</label>
                                    <div class="col-md-2 col-xl-2">
                                        <input name="sizes[]" id="size"
                                            placeholder="Kích cỡ" type="number" class="form-control">
                                        @error('sizes.*')
                                            <p class="text-danger mb-0">{{ $message }}</p>
                                        @enderror
                                    </div>
                            ...
                            <div class="position-relative row form-group">
                                ...
                                <div class="col-md-9 col-xl-8">
                                    <div class="position-relative form-check pt-sm-2">
                                        ...
                                        <label for="featured" class="form-check-label">Thành công</label>
                                    </div>
                                </div>
                            </div>
