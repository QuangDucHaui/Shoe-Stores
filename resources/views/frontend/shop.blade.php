...
@section('content')
    ...
    <div class="container-fluid bg-secondary mb-5">
        <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 300px">
            <h1 class="font-weight-semi-bold text-uppercase mb-3">Shop của tôi</h1>
            ...
            <div class="row px-xl-5">
                ...
                <div class="col-lg-3 col-md-12">
                    ...
                    <div class="border-bottom mb-4 pb-4">
                        ...
                        <button class="btn-primary mt-3 custom-btn" type="submit">Tìm</button>
                    ...
                    <!-- Color Start -->
                    <div class="border-bottom mb-4 pb-4">
                        <h5 class="font-weight-semi-bold mb-4">Tìm theo hãng</h5>
                    ...
                    <!-- Size Start -->
                    <div class="mb-5">
                        <h5 class="font-weight-semi-bold mb-4">Tìm theo kích cỡ</h5>
                            ...
                            <div class="d-flex align-items-center justify-content-between mb-4">
                                <div class="ml-4">
                                    ...
                                    <select name="sort_by" onchange="this.form.submit()">
                                        ...
                                        <option {{request('sort_by') == 'oldest' ? 'selected' : '' }} value="oldest">Lâu nhất</option>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12 pb-1">
                            <div class="card product-item border-0 mb-4">
                                ...
                                <div class="card-footer d-flex justify-content-center bg-light border">
                                    <a href="{{route('product', $product)}}" class="btn btn-sm text-dark p-0"><i class="fas fa-eye text-primary mr-1"></i>Xem chi tiết</a>
                                </div>
                            </div>
                        </div>
                        @endforeach
