            ...
            <div class="col-md-12">
                ...
                <nav>
                    <div class="nav nav-tabs nav-fill">
                        ...
                        <a href="{{route('order-history')}}" class="nav-item nav-link text-primary {{ request()->segment(1) == 'order-history' ? 'active' : ''}}" >Lịch sủ mua hàng</a>
                    ...
                    <div class="tab-pane active show mt-5">
                        <form class="form-change-password" method="POST" action="{{route('profile.update-password')}}">
                            ...
                            <div class="form-group mb-5">
                                <input type="password" class="form-control" name="password_confirmation" placeholder="Xác nhận lại">
                            </div>
                            <div class="text-center">
                                <button type="submit" class="btn btn-primary mb-5">Thay đổi</button>
                            </div>
                        </form>
                    </div>
                </div>
